              ...
              <form method="post" action="{{route('leads.store')}}">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="market-location" name="market_location" placeholder="Market Location" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label class="mb-2 formlabel">Ask Price</label>
                    <input type="text" class="form-control" id="ask-price" name="ask_price" placeholder="Ask Price" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label class="mb-2 formlabel">Price Per Door</label>
                    <input type="text" class="form-control" id="price-per-door" name="price_per_door" placeholder="Price per door" required>
                  </div>
                  <div class="form-group col-md-4">
                    <label class="mb-2 formlabel">Gross Revenue</label>
                    <input type="text" class="form-control" id="gross-revenue" name="gross_revenue" placeholder="Gross Revenue" required>
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="asset-class" name="asset_class" placeholder="Asset Class" required>
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class=" col-md-12">
                    <label class="mb-1 formlabel">Other documents:</label>
                  </div>
