...
<script>
    function openmodal(lead) {
        ...
        if (lead.file) {
            ...
            $("#bgimage").css({
                'background-image': 'url(' + publicurl + '/' + lead.file + ')',
            ...
            $("#bgimage").css({
                'background-image': 'url(' + publicurl1 + '/110-1102927_create-your-profile-user-icon-white-color-hd.png)',
                'background-repeat': 'no-repeat',
                'background-size': 'cover'
            });
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (lead.file) {
                    publicurl = $("#publicurl").val();
                    $("#bgimage").css({
                        'background-image': 'url(' + publicurl + '/' + lead[0].file + ')',
                        'background-repeat': 'no-repeat',
                        'background-size': 'cover'
                    });
                } else {
